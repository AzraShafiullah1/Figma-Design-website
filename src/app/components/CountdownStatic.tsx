...
const CountdownStatic = () => {
    ...
    <div className=" p-6 rounded-lg text-center w-[302px] max-w-md ml-14 pb-3">
        <div className="flex justify-center items-center space-x-4">
          ...
          <span className="text-sm font-small text-black">Days</span>
          ...
          {/* Hours */}
          <div className="text-center">
          <span className="text-sm font-small text-black">Hours</span>
          ...
          {/* Minutes */}
          <div className="text-center">
          <span className="text-sm font-small text-black">Minutes</span>
          ...
          {/* Seconds */}
          <div className="text-center">
          <span className="text-sm font-small text-black">Seconds</span>
